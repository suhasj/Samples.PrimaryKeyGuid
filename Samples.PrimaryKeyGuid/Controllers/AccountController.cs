...
namespace IdentitySample.Controllers {
    ...
    public class AccountController : Controller {
        ...
        public async Task<ActionResult> ConfirmEmail(string userId, string code) {
            ...
            IdentityResult result = await UserManager.ConfirmEmailAsync(Guid.Parse(userId), code);
            if (result.Succeeded) {
        ...
        public async Task<ActionResult> SendCode(string returnUrl) {
            ...
            var userFactors = await UserManager.GetValidTwoFactorProvidersAsync(Guid.Parse(userId));
        ...
        public async Task<ActionResult> SendCode(SendCodeViewModel model) {
            ...
            if (ModelState.IsValid) {
                ...
                // See IdentityConfig.cs to plug in email/txt services to actually send the code
                await UserManager.GenerateTwoFactorTokenAsync(Guid.Parse(userId), model.SelectedProvider);
